					...
					<div class="ui stackable grid container">
						...
						<div class="row">
							<div class="four wide column field">
								...
								<input type="text" name="phone" id="phone" placeholder="Business Phone" value="{{ $user->phone}}">
							</div>
							<div class="four wide column field">
			...
			<div class="content">
				...
				<div class="ui stackable grid container">
					...
					<div class="sixteen wide column">
						...
						<button class="ui button" onclick="location.href='/user_setting/create';">Add Setting</button>
				...
				<div class="ui center aligned stackable grid container">
					<div class="sixteen wide column">
						<div class="ui info message">
							...
							<p>
								Set the storage provider for the associated user if you wish to override the default storage provider.
							</p>
						</div>
					</div>
				</div>
				...
				<div class="ui center aligned stackable grid container">
					...
					<div class="four wide column">
						...
						<div class="four wide column">
						  ...
						  <div class="ui list">
						    <div class="item">
						      <div class="header">Total Backups</div>
						      <div class="meta">
										<p>Total file backups for the user</p>
										<p></p>
						      </div>
						      <div class="description">
