...
CREATE TABLE `backup_file` (
  `file_id` binary(20) NOT NULL COMMENT 'Binary sha-1 hash of the full path to the file',
  `file_name` varchar(255) NOT NULL,
  `file_size` bigint(20) UNSIGNED NOT NULL,
  `user_id` binary(20) NOT NULL,
  `file_type` varchar(16) NOT NULL,
  `hash` binary(20) NOT NULL COMMENT 'Binary sha-1 hash of the file contents',
...
INSERT INTO `backup_ignore_type` (`file_type`, `active`, `updated`) VALUES
('.7z', 1, '2018-02-10 20:09:42'),
('.avi', 1, '2018-02-10 20:09:42'),
('.bat', 1, '2018-02-10 20:08:37'),
('.cab', 1, '2018-02-10 20:10:25'),
('.cmd', 1, '2018-02-10 20:09:42'),
('.dll', 1, '2018-02-10 20:11:30'),
('.exe', 1, '2018-02-10 20:08:37'),
('.flac', 1, '2018-02-10 20:11:30'),
('.inf', 1, '2018-02-10 20:11:30'),
('.ini', 1, '2018-02-10 20:09:42'),
('.iso', 1, '2018-02-10 20:11:30'),
('.itdb', 1, '2018-02-10 20:10:25'),
('.itl', 1, '2018-02-10 20:10:25'),
('.m3u', 1, '2018-02-10 20:09:42'),
('.m4a', 1, '2018-02-10 20:09:42'),
('.m4p', 1, '2018-02-10 20:10:25'),
('.m4v', 1, '2018-02-10 20:09:42'),
('.mkv', 1, '2018-02-10 20:11:30'),
('.mov', 1, '2018-02-10 20:09:42'),
('.mp2', 1, '2018-02-10 20:08:37'),
('.mp3', 1, '2018-02-10 20:08:37'),
('.mp4', 1, '2018-02-10 20:08:37'),
('.mpeg', 1, '2018-02-10 20:08:37'),
('.mpg', 1, '2018-02-10 20:08:37'),
('.msi', 1, '2018-02-10 20:09:42'),
('.nds', 1, '2018-02-10 20:11:30'),
('.ost', 1, '2018-02-10 20:11:30'),
('.pbf', 1, '2018-02-10 20:09:42'),
('.tmp', 1, '2018-02-10 20:11:30'),
('.vmdk', 1, '2018-02-10 20:11:30'),
('.vob', 1, '2018-02-10 20:11:30'),
('.wav', 1, '2018-02-10 20:08:37'),
('.wma', 1, '2018-02-10 20:08:37'),
('.wmv', 1, '2018-02-10 20:10:25');
...
(2, 'temp_storage_path', 'Temporary Storage Path', '/var/www/vessel/storage/parts', 'Filesystem path where temporary file upload data should be stored.', 1, 'Upload', '2018-04-07 01:03:55'),
...
(18, 'max_upload_size', 'Max Upload Filesize', '2147483648', 'Maximum file size for an upload. Default = 2GB', 1, 'File Upload', '2018-04-06 23:48:49');
...
(1, 'Local Storage', 'localhost', '/var/www/vessel/public_html/storage', 'local', '2017-12-26 23:40:48', '2018-04-07 01:15:22'),
(2, 'AWS S3 Storage', '', '', 'cloud', '2018-02-18 20:46:39', '2018-04-07 13:03:57'),
(3, 'Azure Cloud Storage', '', '', 'cloud', '2018-04-07 13:03:43', '2018-04-07 13:03:53'),
(4, 'Google Cloud Storage', '', '', 'cloud', '2018-04-07 13:04:30', '2018-04-07 13:04:30');
...
ALTER TABLE `backup_ignore_type`
  ...
  ADD UNIQUE KEY `idx_file_type` (`file_type`) USING BTREE;
